...
export default function GameInterface() {
    ...
    useEffect(() => {
        const initGame = async () => {
            if (state.gameStarted && state.chatHistory.length === 0 && state.adventure) {
                setIsLoading(true);
                const opening = await generateOpeningNarrative(state.adventure, state.character);
                addChatMessage({
                    type: 'ai',
                    text: opening,
    ...
    return (
        <div className="h-screen flex flex-col bg-gray-50">
                ...
                <div className="px-4 py-3 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">{state.adventure?.setting}</p>
                        </div>
                    </div>
          ...
          w-80 bg-white border-l border-gray-100
